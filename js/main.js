...
document.addEventListener('DOMContentLoaded', () => {
    if (document.querySelector('.js-about-row')) {
        const row = document.querySelector('.js-about-row');
        const aboutCard = [...row.querySelectorAll('.js-about-card')];
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function initPaging() {
        ...
        if (isTablet() && isInited) {
            ...
            const anchors = ['home', 'coll', 'attr', 'about', 'road']
            const labels = ['home', 'ABOUT', 'ATTRIBUTES', 'COLLECTION', 'ROADMAP']
